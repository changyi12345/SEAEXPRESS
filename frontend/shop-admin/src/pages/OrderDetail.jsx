...
export default function OrderDetail() {
  ...
  const fetchOrder = async () => {
    try {
      const res = await axios.get(`/shop-owners/my-shop/orders`)
  ...
  const updateOrderStatus = async (status) => {
    try {
      await axios.put(`/shop-owners/my-shop/orders/${id}/status`, { status })
      fetchOrder()
  ...
  const updatePaymentStatus = async (paymentStatus) => {
    try {
      await axios.put(`/shop-owners/my-shop/orders/${id}/payment`, { paymentStatus })
      fetchOrder()
