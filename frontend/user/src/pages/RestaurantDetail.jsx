    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {closedToday && (
        <div className="mb-4 p-4 bg-red-100 border-2 border-red-500 rounded-lg">
          <p className="font-bold text-red-800">🚫 This restaurant is closed today</p>
      ...
      <div className="mb-6">
        ...
        <p className="text-xl text-gray-600 mb-4">{restaurant.nameMyanmar}</p>
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            <span className="text-yellow-500">⭐</span>
            <span className="ml-1">{restaurant.rating.toFixed(1)}</span>
          </div>
          <span className="text-gray-500">{restaurant.address?.township}</span>
        </div>
      </div>
