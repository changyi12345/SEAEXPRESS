...
export default function Stats() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Income & Statistics</h1>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-4xl font-bold text-primary">{stats?.totalEarnings || 0} Ks</p>
          <p className="text-sm text-gray-500 mt-2">80% of delivery fees</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-gray-600 mb-2">Total Deliveries</h3>
          <p className="text-4xl font-bold text-secondary">{stats?.totalDeliveries || 0}</p>
          <p className="text-sm text-gray-500 mt-2">Completed orders</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-gray-600 mb-2">Average per Delivery</h3>
